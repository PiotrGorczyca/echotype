...
pub const BadDevice = @compileError("unable to translate C expr: expected ')' instead got 'error'");
// /usr/include/X11/extensions/XInput.h:178:9
pub const BadClass = @compileError("unable to translate C expr: expected ')' instead got 'error'");
// /usr/include/X11/extensions/XInput.h:180:9
pub const BadEvent = @compileError("unable to translate C expr: expected ')' instead got 'error'");
// /usr/include/X11/extensions/XInput.h:182:9
pub const BadMode = @compileError("unable to translate C expr: expected ')' instead got 'error'");
// /usr/include/X11/extensions/XInput.h:184:9
pub const DeviceBusy = @compileError("unable to translate C expr: expected ')' instead got 'error'");
// /usr/include/X11/extensions/XInput.h:186:9
